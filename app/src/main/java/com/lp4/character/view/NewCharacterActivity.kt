...
import com.lp4.character.model.NewCharacterViewModel
...
class NewCharacterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.viewState.observe(this) { state ->
            ...
            val arrayAdapter =
                ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, comics)
            val arrayAdapter2 =
                ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, type)
